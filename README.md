...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=22&pause=1000&color=6e40c9&center=true&vCenter=true&width=500&lines=Futuro+Software+Engineer+%F0%9F%8E%AF;Angular+%7C+Java+%7C+Python;Construindo+projetos+reais+%F0%9F%9A%80;Open+to+work+%E2%80%94+Freelancer)](https://git.io/typing-svg)
...
| 🗄️ Bancos de Dados | MySQL · MariaDB · MongoDB · SQL Server |
| 🎮 Game Dev (hobby) | Unity · C# · Blender |
...
<p align="left">
  <img src="https://skillicons.dev/icons?i=angular,ts,js,html,css,java,spring,python,nodejs,mysql,mongodb,git,figma,unity,blender&theme=dark" />
</p>
...
|---------|-----------|------|
| [Noctis Hall](https://github.com/Victor-Harger/Site_CasaDeShow_Angular) | Sistema de gerenciamento e venda de ingressos para casa de shows | `Angular` `TypeScript` |
| [ODASU](https://github.com/Victor-Harger/Projeto-Odasu) | E-Commerce de Salão de Beleza | `HTML` `CSS` `JS` |
| [Reconhecimento Facial](https://github.com/Victor-Harger/Reconhecimento_Facial_Em_Python) | Software de reconhecimento facial em tempo real | `Python` |
